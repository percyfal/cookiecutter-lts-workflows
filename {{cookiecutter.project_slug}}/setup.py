...
setup(
    ...
    url='https://bitbucket.org/{{ cookiecutter.bitbucket_organization }}/{{ cookiecutter.bitbucket_username }}/{{ cookiecutter.project_slug }}',
    packages=[
...
{%- endif %}
    ...
    entry_points = {
        'console_scripts' : [
            '{{ cookiecutter.project_slug }} = {{ cookiecutter.project_slug }}.main:{{ cookiecutter.project_slug }}_wrapper',
        ],
    },
)
